...
class ClientsType extends AbstractType
{
    ...
    {
        $builder
            ->add('genre', ChoiceType::class, ['label' => 'Genre : ', 'attr' => array('class' => 'choice'), 'label_attr' => array('class' => 'labelClient'),  'choices'  => [
                'Madame' => true,
                'Monsieur' => false,
            ],])
            ...
            ->add('rgpdPanel', CheckboxType::class, ['label' => 'J’accepte de recevoir les actualités et les offres du centre commercial Aushopping Portes du futur :','attr' => array('class' => 'checkbox'), 'required' => false,  'label_attr' => array('id' => 'checkLabel', "default" =>false)])
